...
/**
 * Stellt eine Ziffer graphisch in einem Feld dar. Das Zifferfeld kann in drei
 * verschiedenen Farben aufleuchten. Das Ziffernfeld reagiert auf Mausklicks.
 */
...
public class Ziffer extends JLabel {
	...
	/**
	 * Erzeugt ein Feld, das eine Ziffer darstellt. Das erste Feld stellt die Ziffer
	 * 1 dar, das zweite, das erzeugt wird, die Ziffer 2 usw. Wird das Ziffernfeld
	 * mit der linken Maustaste angeklickt, wird die Spielkonsole, zu der das
	 * Ziffernfeld gehoert, darüber informiert.
	 * 
